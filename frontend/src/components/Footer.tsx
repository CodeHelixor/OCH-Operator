const Footer = () => {
  return (
    <footer className="min-h-12 flex-shrink-0 flex items-center justify-end pr-4 lg:pr-8 py-2 bg-white/30 backdrop-blur-sm border-t border-slate-200/80 shadow-top text-slate-700 transition-[box-shadow,border-color] duration-280 ease-[cubic-bezier(0.4,0,0.2,1)]">
