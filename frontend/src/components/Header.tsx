...
const Header = () => {
  ...
  return (
    <header className="p-4 min-h-[5rem] flex items-center justify-between lg:p-10 bg-white/70 backdrop-blur-sm shadow-sm border-b border-slate-200/80 transition-[box-shadow,border-color] duration-280 ease-[cubic-bezier(0.4,0,0.2,1)]">
